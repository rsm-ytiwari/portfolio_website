...
<!-- ═══════════════════════════════════════════════════════════
     ...
     SPLASH PAGE — card-krueger-replication
═══════════════════════════════════════════════════════════════ -->
<header class="navbar">
...
<div class="splash-container">
  ...
  <div class="splash-content">
    ...
    <h1 class="splash-title">Replicating Card &amp; Krueger (1994): When the Minimum Wage Didn&rsquo;t Bite</h1>
    ...
    <a href="./card-krueger-replication.html" class="splash-button">Read Article</a>
  </div>
</div>
```
