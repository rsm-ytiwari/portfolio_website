...
<!-- ═══════════════════════════════════════════════════════════
     ...
     EDIT: date, read_time, category, title, subtitle, article_href
═══════════════════════════════════════════════════════════════ -->
<div class="splash-container">
  ...
  <div class="splash-content">
    ...
    <h1 class="splash-title">Article Title Here</h1>

    <p class="splash-subtitle">
      One-sentence hook that describes the article's thesis and earns a click.
    </p>

    <a href="./article-slug.html" class="splash-button">Read Article</a>
  </div>
</div>
```
